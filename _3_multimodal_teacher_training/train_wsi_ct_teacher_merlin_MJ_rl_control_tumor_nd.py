...
from _3_multimodal_teacher_training.config.acmil_ct_config import get_parser
...
if __name__ == '__main__':
    ...
    lr_wsi_backbones = [1e-4, 1e-5]
    lr_wsi_heads = [1e-4, 1e-5]
    lr_news = [5e-4, 1e-4, 1e-5]
        ...
        for lr_wsi_head in lr_wsi_heads:
            ...
            for lr_new in lr_news:
                ...
                val_dataset = RCCDatasetWSITumor(args=args, pid_col_name=pid_col_name,
                                                  pid=train_val_pair_wsi_info_val[pid_col_name].values,
                ...
                for epoch in range(args.epochs):
                    ...
                    if epoch % 1 == 0:
                        ...
                        filename = (
                            f"../checkpoints/ck_wsi_ct/ep{epoch}_Tm{args.Tmax}_nmp{args.n_masked_patch}_nt{args.n_token}_md{args.mask_drop}"
                            f"_wd{args.weight_decay}_lr{args.lr}_mb{args.mini_batch}")
